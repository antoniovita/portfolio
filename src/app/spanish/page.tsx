...
const Home = () => {
  ...
  const sendEmail = (e: FormEvent<HTMLFormElement>) => {
    ...
    const title = "Un poco de mi trabajo";

    const projects = [
  {
    id: 1,
    title: 'IRSA: Radiología por Imagen',
    description: 'Proyecto SPA realizado con Next.js y TailwindCSS',
  ...
  {
    id: 2,
    title: 'MyOrder – Menú digital para Restaurantes',
    description: 'Menú digital interactivo para restaurantes, con interfaz responsiva que permite pedidos sin personal humano.',
  ...
  {
    id: 3,
    title: 'Gymtracker - App de Gestión de Entrenamientos',
    description: 'Aplicación móvil desarrollada para ayudarme a seguir y organizar mis entrenamientos en el gimnasio.',
    ...
    <div className="min-h-screen bg-transparent text-white flex flex-col relative overflow-auto">
      ...
      <div className="relative">
        <motion.div initial={{ opacity:0 }} whileInView={{ opacity: 1 }} transition={{ duration: 3, ease: "easeOut" }} viewport={{ amount: 0.2 }} className="relative flex flex-col items-center justify-center z-30 text-white h-screen px-4">
            ...
            <p className="bg-black text-md font-thin text-center"> Estudiante de Ciencias de la Computación en PUC-Rio & Desarrollador Full-Stack </p>
            ...
            <a href="#about" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} className="bg-black duration-300 all-transition hover:text-white flex flex-col justify-center items-center text-gray-200">
              <p className="font-thin"> Veer Más </p>
              <svg
  ...
  <div className="flex flex-col justify-center items-center h-screen relative"> 
    ...
    <button onClick={() => setShowStack(true)} className="bg-yellow-400 text-black rounded-full px-3 py-2 mt-5 font-normal hover:bg-yellow-900 hover:text-black all-transition duration-300"> Abrir la lista </button>
  ...
  <motion.div className="sm:mt-4 p-4 sm:p-10 md:p-20 flex flex-col justify-center space-y-4 max-w-[700px]" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 3, ease: "easeOut" }} viewport={{ amount: 0.2 }}>
    ...
    ¿ Que puedo decir de <span className="text-yellow-300">mi </span>?
    </h1>
    <p className="text-sm sm:text-md md:text-lg font-light text-gray-300 text-center md:text-left">
    Soy estudiante de Ciencias de la Computación en la PUC-Rio con una beca por mérito. Tengo un año de experiencia en desarrollo web, principalmente con TypeScript, React, Node.js y bases de datos como MongoDB y PostgreSQL. También me interesa el desarrollo en blockchain y siempre estoy buscando aprender más.
    </p>
