     ...
     <div className="stars-background">
      ...
      <div className="relative pt-20">
        <div className="pt-20 relative flex flex-col items-center justify-center z-30 text-white mt-[200px] mb-[500px]">
            <h1 className="text-5xl font-bold mb-3">Hello, I'm <span className="text-yellow-300">Antonio Vita</span></h1>
            <p className="text-lg mb-6 font-light">Aqui você verá alguns dos meus projetos incríveis.</p>
            <a href="#projects" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} className="duration-300 all-transition hover:text-white flex flex-col justify-center items-center text-gray-200">
      ...
      <div className="swiper-container w-full mb-[500px]">
        <Swiper
          spaceBetween={20}
          slidesPerView={3}
          navigation
      ...
      <div className="flex items-center justify-center gap-[120px] z-30 mb-[300px]">
          ...
          <div className=" p-20 flex flex-col justify-center space-y-4 max-w-[700px]">
            <h1 className="text-4xl font-semibold text-white" >Lorem ipsum dolor sit amet.</h1>
            <p className="text-lg font-light text-gray-300">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Assumenda beatae animi at illum debitis asperiores vel sequi repellat unde. Deserunt possimus, fuga animi soluta quasi dolorem eos obcaecati iusto dignissimos!</p>
          </div>
